...
class FixtureRootModel {
  ...
  FixtureRootModel.fromJson(Map<String, dynamic> json) {
    fixture =
...
class Parameters {
  ...
  Parameters({this.season, this.date});
...
class Fixture {
  ...
  Fixture.fromJson(Map<String, dynamic> json) {
    ...
    date = json['date'] != null
        ? changeDate((json['date'] as String).replaceAll('T', ' '))
        : null;
  ...
  DateTime changeDate(String date) {
    date = date.substring(0, date.indexOf('+'));
    var format = DateFormat('yyyy-MM-dd HH:mm').parse(date);
    return format;
  }
}
